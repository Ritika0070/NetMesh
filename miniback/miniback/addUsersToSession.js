...
async function addUsers() {
  ...
  console.log(`[OK] Session found: ${session.name} (${SESSION_ID})`);
  ...
  console.log(`[OK] Found ${seededUsers.length} seeded users to add.`);
  ...
  console.log(`     Total participants: ${session.participants.length}`);
  console.log(`     Session extended to 48 hours.`);
  console.log("\nRefresh your app — recommendations should now appear.");
